  ...
  <div class="container">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-8">
            ...
            <p>
              <select v-model="purchasecreate.product"  class="form-control">
        ...
        <div class="row">
          <div class="col-8">
            <h5>Firma unvanı:</h5>
            <p>
              <select v-model="purchasecreate.company"  class="form-control">
          ...
          <div class="col-4">
            ...
            <p>
              <input
                type="text"
                class="form-control"
                v-model="purchasecreate.referance"
        ...
        <div class="row">
          <div class="col-8">
            <h5>Adres :</h5>
            <p>
              <select v-model="purchasecreate.deliveryAddress"  class="form-control">
                <option value="0" selected disabled>address seçiniz</option>
                <option v-for="(address,index) in purchasecreate.company.addresses" :key="index" :value="address._id">{{address.address}}</option>
              </select>
            </p>
          </div>
          <div class="col-4">
            <h5>kontak kişi :</h5>
            <p>
              <select v-model="purchasecreate.contact"  class="form-control">
    ...
    <div class="row">
      <table class="table table-sm" id="purchaseTable">
        ...
        <tbody>
          <tr v-for="(item, index ) in purchasecreate.items" v-bind:key="index">
            <th scope="row">
              <button
                v-if="index>0"
                type="button"
    ...
    <div class="row">
      <h5>Notes</h5>
      <textarea v-model="purchasecreate.note" class="form-control" cols="20" rows="3"></textarea>
    </div>
    <br />
    <div class="row justify-content-center">
...
export default {
  ...
  created: function() {
    if (this.purchase != null) {
      this.purchasecreate = this.purchase;
    }
    axios
  ...
  methods:{
    total: function() {
      let tmp = 0;
      try {
        this.purchasecreate.items.forEach(fofo);
        function fofo(item) {
    ...
    addrow: function() {
      this.purchasecreate.items.push({
        id: "",
        materialNumber: "",
        description: "",
        unitPrice: "",
    ...
    deleteRow: function(index) {
      this.purchasecreate.items.splice(index, 1);
    },
    save: function (){
    ...
    update: function (){
        ...
        .put('http://localhost:5000/invoice',{
          id: this.purchasecreate._id, 
          type: "purchase", 
          date: this.purchasecreate.date,
          referance: this.purchasecreate.referance,
          note: this.purchasecreate.note,
          status: "updated",
          items: this.purchasecreate.items,
          deliveryAddress: this.purchasecreate.deliveryAddress,
          company: this.purchasecreate.company._id,
          product: this.purchasecreate.product._id,
          contact: this.purchasecreate.contact._id,
        })
        .then(res => {
